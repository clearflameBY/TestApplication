...
extension MainViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
            ...
            cell.configure(with: [
                "https://placehold.co/600x200/FF5733/FFFFFF?text=Скидка+20%25",
                "https://placehold.co/600x200/33FF57/FFFFFF?text=Новинки+меню",
                "https://placehold.co/600x200/3357FF/FFFFFF?text=Бесплатная+доставка"
            ])
            return cell
        } else {
            // Meal Cell
